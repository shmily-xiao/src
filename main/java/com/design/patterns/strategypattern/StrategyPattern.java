...
public class StrategyPattern {
    ...
    public static void main(String[] args) {
        ...
        Pay pay = PayFactory.instantiated(selectEnum(type,sale,reduceMoney));
        pay.initData(sale,reduceMoney);
        System.out.println("if have no coupons, you should pay " + computePrice(goodsList));
        System.out.println("you should pay " + pay.computePrice(goodsList));
